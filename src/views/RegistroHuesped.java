...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(String numeroReserva) {
		...
		JLabel lblNumeroReservaTitulo = new JLabel("NÚMERO DE RESERVA: ");
		lblNumeroReservaTitulo.setBounds(560, 474, 253, 14);
		lblNumeroReservaTitulo.setForeground(SystemColor.textInactiveText);
		lblNumeroReservaTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		contentPane.add(lblNumeroReservaTitulo);

		JLabel lblNumeroReserva = new JLabel(numeroReserva);
		lblNumeroReserva.setBounds(560, 495, 285, 33);
		lblNumeroReserva.setFont(new Font("Roboto", Font.PLAIN, 16));
