...
public class ReservasView extends JFrame {
	...
	private void calcularValorReserva() {
	    if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
	        long diferenciaEnMilisegundos = txtFechaSalida.getDate().getTime() - txtFechaEntrada.getDate().getTime();
	...
	public ReservasView() {
		...
		valorPanel.setLayout(new BoxLayout(valorPanel, BoxLayout.X_AXIS));
		    ...
		    public void mouseClicked(MouseEvent e) {
		        if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
		            ...
		            try {
		                ...
		                JOptionPane.showMessageDialog(null, "Error en el valor de la reserva.");
		            }
		        } else {
