...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Eric Rojo © 2023");
		...
		btnExit.addMouseListener(new MouseAdapter() {
		    ...
		    public void mouseClicked(MouseEvent e) {
		        int choice = JOptionPane.showConfirmDialog(
		            MenuPrincipal.this, "¿Estás seguro de que deseas salir?", "Confirmar Salida",
		...
		lblRegister.setBounds(754, 375, 83, 24);
		lblRegister.setHorizontalAlignment(SwingConstants.CENTER);
		lblRegister.setForeground(SystemColor.textHighlight);
		lblRegister.setFont(new Font("Roboto Light", Font.PLAIN, 16));
		...
		lblRegister.addMouseListener(new MouseAdapter() {
		    ...
		    @Override
		    public void mouseEntered(MouseEvent e) {
		        lblRegister.setForeground(SystemColor.textHighlight.darker());
		    }
