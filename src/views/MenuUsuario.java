...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		// Agregar un nuevo botón para redirigir al menú de inicio de sesión
		...
		btnLogin.setBounds(0, 369, 257, 56);
		btnLogin.setBackground(new Color(12, 138, 199));
		panelMenu.add(btnLogin);
		btnLogin.setLayout(null);

		JLabel lblLogin = new JLabel("Salir");
		lblLogin.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/login.png")));
		lblLogin.setBounds(27, 11, 200, 34);
